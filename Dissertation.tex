...
This investigation focused on transferring data between GPUS, measuring the throughput and analysing the steps involved in initiating transfers from APIs
