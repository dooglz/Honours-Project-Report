...
\section{Literature Review}
	\subsubsection{Data trasfer between nodes in a muti-node system}
		\lipsum[2]
		\cite{MantleAPI}
		\cite{GpuPipeComp}
		\cite{GpuTextComp}
	...
	\lipsum[2]
	\cite{GpuFP}
	\cite{Patel12parallellossless}
	\cite{Cederman08apractical}
	\subsubsection{Gpu Compression}
	\lipsum[2]
	
	\subsubsection{Multi-Gpu Data Transfer}
	\lipsum[2]
